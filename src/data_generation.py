...
'''
from utils import (crop_raster, compute_parameters, stack_rasters)
import os
...
# Crop data
crop_raster("tn_elevation.tif", "cropped_tn_elevation.tif", tn_bbox)
crop_raster("ca_elevation.tif", "cropped_ca_elevation.tif", ca_bbox)
crop_raster("NDVI_Tennessee.tif", "cropped_tn_ndvi.tif", tn_bbox)
crop_raster("NDVI_California.tif", "cropped_ca_ndvi.tif", ca_bbox)

# Compute terrain parameters
compute_parameters("cropped_tn_elevation.tif", "tn")
compute_parameters("cropped_ca_elevation.tif", "ca")
