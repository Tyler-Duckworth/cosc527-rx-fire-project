...
# rf.crop_raster("SMAP_California.tif", "cropped_ca_smap.tif", ca_bbox)
# rf.crop_raster("SMAP_Tennessee.tif", "cropped_tn_smap.tif", ca_bbox)
...
rf.stack_rasters(
    ...
    "../stacked_tn.tif", 
    metadata={"AMBTEMP": 46, "RELHUM": 0.6, "WIND": "-2,0", "BBOX": ",".join(map(str, tn_bbox))}
)
...
rf.stack_rasters(
    ...
    "../stacked_ca.tif",
    metadata={"AMBTEMP": 70, "RELHUM": 0.7, "WIND": "0,10.7", "BBOX": ",".join(map(str, ca_bbox))}
)
